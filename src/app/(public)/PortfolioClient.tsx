...
const FloatingWhatsApp = () => {
  return (
    ...
    >
      {/* Tooltip */}
      <span className="absolute right-16 px-4 py-2 bg-card border border-white/10 rounded-xl text-white text-lg md:text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-xl neumorphic pointer-events-none translate-x-2 group-hover:translate-x-0">
        Chat on WhatsApp
      </span>
              ...
              <div className="col-span-1 lg:col-span-7">
                ...
                >
                  ...
                  <div className="hidden lg:block">
                    <p className="text-gray-400 text-lg md:text-xs sm:text-sm md:text-lg leading-relaxed mb-6 md:mb-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16">
            ...
            >
              ...
              <div className="p-6 md:p-10 bg-card rounded-2xl md:rounded-[2.5rem] neumorphic border border-white/5">
                <p className="text-gray-500 italic text-lg md:text-xs md:text-sm leading-relaxed">
