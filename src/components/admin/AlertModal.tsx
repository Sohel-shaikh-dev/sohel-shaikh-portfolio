...
export function AlertModal({ 
  ...
  useEffect(() => {
    if (isOpen && autoCloseDelay && type === 'success') {
      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-card border border-white/10 rounded-3xl p-8 max-w-sm w-full shadow-2xl relative overflow-hidden text-center items-center flex flex-col gap-4 z-10"
          >
